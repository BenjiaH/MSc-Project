function [settings, EKF_track]  = initSettingsNT1065_config1_L1()
...
settings.fileName           = ...
    'C:\dataSandbox\FGI_dataFiles\GPS_GAL_No_Errors_1min_int8.dat';
% 'PRN_4_Dopp_42270noiseAmp_20phase_0_bits_8.dat';
%   'C:\sandbox\test signal generation\PRN_4_Dopp_270noiseAmp_20phase_0_bits_2.dat';  
%       'C:\sandbox\test signal generation\testOutput_2bits.dat';  
%     'C:\sandbox\test signal generation\testOutput.dat';   
%   '../dataCaptures/Config1m130dBm_int8.dat';
%     'C:\sandbox\NT1065_USB3_documentation_v1.36\NT1065_USB3_documentation_v1.36\Windows\sampler-nt1065-win-2.0.8.2\Sampler-NT1065-win-2.0.8.2\CH1parkside_39_allCH_2_int8.dat';
%     'C:\sandbox\SWRX_NOOELEC_SDR\GNSS_SWRx\PRN4Mulitpath_Amp_0p5_Phase_0_60s.dat';
%     'C:\sandbox\NT1065_USB3_documentation_v1.36\NT1065_USB3_documentation_v1.36\Windows\sampler-nt1065-win-2.0.8.2\Sampler-NT1065-win-2.0.8.2\CH2dualTest1_int8.dat';
%     'C:\sandbox\NT1065_USB3_documentation_v1.36\NT1065_USB3_documentation_v1.36\Windows\sampler-nt1065-win-2.0.8.2\Sampler-NT1065-win-2.0.8.2\CH12CHL1CA_window_stick2_int8.dat';
%   'C:\sandbox\dataLogs\matt\mtest_gps2_int8.dat';
...
% up acquisition
settings.acqSatelliteList= [2 5 7 9 11 13 20 30];       %[PRN numbers]
