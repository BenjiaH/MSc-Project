...
% based only. 
settings.skipNumberOfBytes     = 2*53e6;

%% Raw signal file name and other parameter ===============================
% This is a "default" name of the data file (signal record) to be used in
% the post-processing mode
settings.fileName           = ... 
   '../dataCaptures/NewFrontEndConfigm130dBm_int8.dat';
...
settings.samplingFreq       = (1580e6)/27/2;     %[Hz]
...
% up acquisition
settings.acqSatelliteList   = 1;         %[PRN numbers]
