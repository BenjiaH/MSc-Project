...
L5data = load('L1_5e17_TrackingResults.mat');
...
for channelNr = channelList
    ...
    travelTime(channelNr) = (-L5data.trackResults(channelNr).remCodePhase(msOfTheSignal(channelNr))*samplesPerChip + ...
        L5data.trackResults(channelNr).absoluteSample(msOfTheSignal(channelNr))) / samplesPerCode;
end
