function [multiSettings]  = initSettingsSignal()
...
%
%   Outputs:
%       multiSettings     - Receiver multiSettings (a structure). 
%       EKF_track    - EKF tracking multiSettings (a structure). 

%% Processing multiSettings ====================================================
% Number of milliseconds to be processed used 36000 + any transients (see
% below - in Nav parameters) to ensure nav subframes are provided
multiSettings.msToProcess        = 20000;        %[ms]

% Data type used to store one sample
multiSettings.dataType           = 'int8';

% Intermediate, sampling and code frequencies
multiSettings.IF                 = 100e3;      %[Hz]
multiSettings.samplingFreq       = 1.5e6;     %[Hz]
