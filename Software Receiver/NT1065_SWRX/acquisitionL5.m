function acqResults = acquisitionL5(longSignal, settings)
...
%% Correlate signals ======================================================   
    ...
    L5codeFreqDom = conj(fft(L5codesTable(PRN, :)));
    ...
    for frqBinIndex = 1:numberOfFrqBins
        ...
        %domain)
        convCodeIQ1 = IQfreqDom1 .* L5codeFreqDom;
        convCodeIQ2 = IQfreqDom2 .* L5codeFreqDom;
