function [settings, EKF_track]  = initSettingsFH_L5()
...
% based only. 
settings.skipNumberOfBytes     = 30*40.96e6;

%% Raw signal file name and other parameter ===============================
% This is a "default" name of the data file (signal record) to be used in
% the post-processing mode
settings.fileName =  'E:\L5 receiver\datalogs\GPS_staticL1L5_allm140_60s_L5_usb2.mat';
...
% up acquisition
settings.acqSatelliteList   = [10];         %[PRN numbers]
