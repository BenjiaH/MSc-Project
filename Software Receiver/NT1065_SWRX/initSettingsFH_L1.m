function [settings, EKF_track]  = initSettingsFH_L1()
...
% based only. 
% settings.skipNumberOfBytes     = round(1.429*40.96e6)-5920-10240;
settings.skipNumberOfBytes     = 1*40.96e6;
% settings.skipNumberOfBytes     = round(20*40.96e6);
%% Raw signal file name and other parameter ===============================
% This is a "default" name of the data file (signal record) to be used in
% the post-processing mode
settings.fileName =    ...
'\\esplabnas1\weakheo\WeakHEO2\_Work\WP4000 PoC realization\receiver_data_recording\test ad9361\test_ad9361prn4_L1_usb1.bin'; 
% '\\esplabnas1.epfl.ch\weakheo\WeakHEO2\_Work\WP4000 PoC realization\receiver_data_recording\test l5\test_l5_L1_usb1.bin';
% '\\esplabnas1.epfl.ch\weakheo\WeakHEO2\HEO_scenairo_log_file\HEO_scenario_signal_40sec_for_eph_L1_usb1.bin';

% '\\esplabnas1\weakheo\WeakHEO2\_Work\WP4000 PoC realization\Sensitivity testing\directLNAMAX2669_m130dBm15s_then_m150dBm_tillEnd_L1_usb1.bin';
%'\\esplabnas1.epfl.ch\weakheo\WeakHEO2\_Work\WP4000 PoC realization\receiver_data_recording\singleChannel_directLNA_m120dBm_20s_L1_usb1.bin';
...
settings.IF                 = 12.82e6 ;      %[Hz]
settings.samplingFreq       = 40.96e6;     %[Hz]
...
% up acquisition
settings.acqSatelliteList   = [4];         %[PRN numbers]
% Band around IF to search for satellite signal. Depends on max Doppler
settings.acqSearchBand      = 10;           %[kHz]
% Threshold for the signal presence decision rule
settings.acqThreshold       = 5.96;
...
% high dynamics setting
EKF_track.Q_omegaDot=25;
