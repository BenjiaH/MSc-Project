function [trackResults, channel]= tracking_FLL_2ndOrderKnownDataL5(fid, channel, settings)
% Performs code and carrier tracking for all channels.
%
%[trackResults, channel] = tracking_FLL_2ndOrderKnownData(fid, channel, settings)
%
%   Inputs:
...
%% Generate the six standard accumulated values ---------------------------
            ...
            % no data transitions so just switch to 20ms accumulation after 5s
            if loopCnt == 5000                         
...
%% Find PLL error and update carrier NCO         
                ...
                % moving average carrier lock indicator
                carrLockInd = carrLockInd + (dot - carrLockInd)/(3000/coherentAccmNum);
                % moving average code lock indicator
...
%% Find DLL error and update code NCO -------------------------------------
                ...
                %Code discriminator normalisation 
                ...
                deltaFco_k = settings.spectrumInversion*((carrFreq - settings.IF)/1150);
