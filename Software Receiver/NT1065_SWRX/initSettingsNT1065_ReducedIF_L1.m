...
% settings.fileName           =  'C:\dataSandbox\reduced_samples_rateNT1065\CH1reducedIF_simSampling_L1_25MHz_L5_25MHz_5dBGlobal_int8.dat';

settings.fileName           = 'C:\dataSandbox\reduced_samples_rateNT1065\reducedSimRate\CH1Sim25MHz_5dB_Global_reducedIF_int8.dat';
...
settings.IF                 = (33.74/3)*1e6;      %[Hz]
settings.Doppler            = 0;
settings.samplingFreq       = (148.75/3)*1e6;     %[Hz]
