function [settings, EKF_track]  = initSettingsNT1065_ReducedIF_L1()
...
% based only. 
settings.skipNumberOfBytes     = 5*50e6;

%% Raw signal file name and other parameter ===============================
% This is a "default" name of the data file (signal record) to be used in
% the post-processing mode
settings.fileName           = 'C:\dataSandbox\reduced_samples_rateNT1065\reducedSimRate\CH1SIM_25_8MHzIF_30MHzfilter_int8.dat';

% settings.fileName           =  'C:\dataSandbox\reduced_samples_rateNT1065\CH1reducedIF_fs_8MHz_IF_L1_49MHz_simSampling25MHz_5dBGlobal_int8.dat';
...
settings.IF                 = (23.74/3)*1e6;      %[Hz]
settings.Doppler            = 0;
settings.samplingFreq       = (148.4375/3)*1e6;     %[Hz]
...
settings.measurementPoints = 1:ceil(settings.samplingFreq*(settings.navSolPeriod/1000)):(settings.samplingFreq*(settings.msToProcess/1000));
